...
function getConverterByFormat(format: format, source: any, options: object = {}): ConvertorInterface {
...
export async function convertData(source: Ms3.apiInterfaces.API, from: format, to: format, options?: object) {
...
export async function convertDataFromFile(sourcePath: string, from: format, to: format, options?: object) {
  validateConvertFormats(from, to);
