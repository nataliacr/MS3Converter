...
const originalResourcesWithRequestBody: MS3 = {
  'settings': {
    'title': 'params',
    'baseUri': 'http://params'
  },
...
const resultResourcesWithRequestBody: OAS = {
  openapi: '2.0',
  info: {
    title: 'params',
    description: 'API description',
...
export { originalResourcesWithRequestBody, resultResourcesWithRequestBody };